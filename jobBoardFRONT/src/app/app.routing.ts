...
const routes: Routes = [
    ...
    {path: 'index',canActivate: [NoAuthGuard], component: HomepageComponent},
    {path: 'contactus',canActivate: [NoAuthGuard], component: ContactusComponent},
    {path: 'aboutus',canActivate: [NoAuthGuard], loadChildren: './aboutus/aboutus.module#AboutusModule'},
